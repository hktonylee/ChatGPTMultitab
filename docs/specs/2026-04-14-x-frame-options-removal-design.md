...
- `src/background.js` reads saved URLs, installs dynamic DNR rules at startup/install, and exposes a message handler so the options page can refresh rules immediately after saving.
