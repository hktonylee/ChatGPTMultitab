...
I made it so ChatGPT is ready in 1-2 seconds: no hunting for the right Chrome window or tab, no waiting for the UI to load, and no giving up the 100% official ChatGPT interface.
